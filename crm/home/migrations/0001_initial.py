# Generated by Django 5.2.1 on 2025-05-24 12:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('forwarded', 'Forwarded to Doctor'), ('done', 'Prescription Done')], default='forwarded', max_length=20)),
                ...
                ('assigned_doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patients_assigned', to=settings.AUTH_USER_MODEL)),
